...
import static org.culturegraph.mf.iso2709.Iso2709Constants.BASE_ADDRESS_LENGTH;
import static org.culturegraph.mf.iso2709.Iso2709Constants.BASE_ADDRESS_START;
import static org.culturegraph.mf.iso2709.Iso2709Constants.FIELD_LENGTH_LENGTH_POS;
import static org.culturegraph.mf.iso2709.Iso2709Constants.FIELD_START_LENGTH_POS;
import static org.culturegraph.mf.iso2709.Iso2709Constants.IDENTIFIER_LENGTH_POS;
import static org.culturegraph.mf.iso2709.Iso2709Constants.IMPL_CODES_LENGTH;
import static org.culturegraph.mf.iso2709.Iso2709Constants.IMPL_CODES_START;
import static org.culturegraph.mf.iso2709.Iso2709Constants.IMPL_DEFINED_PART_LENGTH_POS;
import static org.culturegraph.mf.iso2709.Iso2709Constants.INDICATOR_LENGTH_POS;
import static org.culturegraph.mf.iso2709.Iso2709Constants.MAX_BASE_ADDRESS;
import static org.culturegraph.mf.iso2709.Iso2709Constants.MAX_RECORD_LENGTH;
import static org.culturegraph.mf.iso2709.Iso2709Constants.MIN_BASE_ADDRESS;
import static org.culturegraph.mf.iso2709.Iso2709Constants.MIN_RECORD_LENGTH;
import static org.culturegraph.mf.iso2709.Iso2709Constants.RECORD_LABEL_LENGTH;
import static org.culturegraph.mf.iso2709.Iso2709Constants.RECORD_LENGTH_LENGTH;
import static org.culturegraph.mf.iso2709.Iso2709Constants.RECORD_LENGTH_START;
import static org.culturegraph.mf.iso2709.Iso2709Constants.RECORD_STATUS_POS;
import static org.culturegraph.mf.iso2709.Iso2709Constants.RESERVED_CHAR_POS;
import static org.culturegraph.mf.iso2709.Iso2709Constants.SYSTEM_CHARS_LENGTH;
import static org.culturegraph.mf.iso2709.Iso2709Constants.SYSTEM_CHARS_START;
