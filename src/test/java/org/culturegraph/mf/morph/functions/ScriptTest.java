...
public final class ScriptTest {
  ...
  public void shouldExecuteJavascriptFunctions() {
    metamorph = InlineMorph.in(this)
        ...
        .with("    <script file='org/culturegraph/mf/morph/functions/script-test.js' invoke='process' />")
        .with("  </data>")
        .with("  <data source='data2'>")
        .with("    <script file='org/culturegraph/mf/morph/functions/script-test.js' invoke='process2' />")
        .with("  </data>")
        .with("</rules>")
